...
public:
    ...
    //  * @return 成功为0，失败为非0
    //  */
    virtual int GetFeatureKey(example::RankStruct &rank_struct) = 0;
    ...
    //  * @return 成功为0，失败为非0
    //  */
    virtual int DoRank(example::RankStruct &rank_struct) = 0;
...
//for creating class
typedef qihoo::ad::ranking::Rank RankType;

extern "C" int RankingStaticInit(const char* conf_path);
